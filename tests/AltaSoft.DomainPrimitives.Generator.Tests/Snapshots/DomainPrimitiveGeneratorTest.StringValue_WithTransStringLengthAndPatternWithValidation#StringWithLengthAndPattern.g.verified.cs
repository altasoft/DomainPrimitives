...
internal partial class StringWithLengthAndPattern : IEquatable<StringWithLengthAndPattern>
        , IComparable
        , IComparable<StringWithLengthAndPattern>
        , IParsable<StringWithLengthAndPattern>
        , IConvertible
{
    /// <inheritdoc/>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="StringWithLengthAndPattern"/> class by validating the specified <see cref="string"/> value using <see cref="Validate"/> static method.
    /// </summary>
...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
    ...
    /// <summary>
    /// Implicit conversion from <see cref = "string"/> (nullable) to <see cref = "StringWithLengthAndPattern"/> (nullable)
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    /// <summary>
    /// Implicit conversion from <see cref = "StringWithLengthAndPattern"/> (nullable) to <see cref = "string"/> (nullable)
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [return: NotNullIfNotNull(nameof(value))]
