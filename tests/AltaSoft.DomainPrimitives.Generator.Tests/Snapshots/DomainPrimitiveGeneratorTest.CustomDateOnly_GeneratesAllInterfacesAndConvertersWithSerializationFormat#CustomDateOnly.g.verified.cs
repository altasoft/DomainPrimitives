...
[TypeConverter(typeof(CustomDateOnlyTypeConverter))]
[UnderlyingPrimitiveType(typeof(DateOnly))]
[DebuggerDisplay("{_value}")]
public readonly partial struct CustomDateOnly : IEquatable<CustomDateOnly>
        , IComparable
        , IComparable<CustomDateOnly>
        , IComparisonOperators<CustomDateOnly, CustomDateOnly, bool>
        , ISpanFormattable
        , IParsable<CustomDateOnly>
        , IConvertible
...
#endif
{
    ...
    private DateOnly _valueOrThrow => _isInitialized ? _value : throw InvalidDomainValueException.NotInitializedException(typeof(CustomDateOnly));
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="CustomDateOnly"/> class by validating the specified <see cref="DateOnly"/> value using <see cref="Validate"/> static method.
    /// </summary>
    /// <param name="value">The value to be validated.</param>
    public CustomDateOnly(DateOnly value) : this(value, true)
    {
    }

    private CustomDateOnly(DateOnly value, bool validate) 
    {
        if (validate)
        {
    ...
    /// </summary>
    /// <param name="value">The value to create CustomDateOnly from</param>
    ...
    public static bool TryCreate(DateOnly value, [NotNullWhen(true)] out CustomDateOnly? result)
    {
    ...
    public void ValidateOrThrow(DateOnly value)
    {
        ...
        if (!result.IsValid)
        	throw new InvalidDomainValueException(result.ErrorMessage, typeof(CustomDateOnly), value);
    }
    ...
    /// <inheritdoc/>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool operator !=(CustomDateOnly left, CustomDateOnly right) => !(left == right);
    ...
    public int CompareTo(object? obj)
    {
        ...
        if (obj is CustomDateOnly c)
            return CompareTo(c);

        throw new ArgumentException("Object is not a CustomDateOnly", nameof(obj));
    }

    /// <inheritdoc/>
    public int CompareTo(CustomDateOnly other)
    {
    ...
    /// <summary>
    /// Implicit conversion from <see cref = "DateOnly"/> to <see cref = "CustomDateOnly"/>
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator CustomDateOnly(DateOnly value) => new(value);

    /// <summary>
    /// Implicit conversion from <see cref = "DateOnly"/> (nullable) to <see cref = "CustomDateOnly"/> (nullable)
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [return: NotNullIfNotNull(nameof(value))]
    public static implicit operator CustomDateOnly?(DateOnly? value) => value is null ? null : new(value.Value);

    /// <summary>
    /// Implicit conversion from <see cref = "CustomDateOnly"/> to <see cref = "DateOnly"/>
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator DateOnly(CustomDateOnly value) => (DateOnly)value._valueOrThrow;

    /// <summary>
    /// Implicit conversion from <see cref = "CustomDateOnly"/> (nullable) to <see cref = "DateOnly"/> (nullable)
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [return: NotNullIfNotNull(nameof(value))]
    public static implicit operator DateOnly?(CustomDateOnly? value) => value is null ? null : (DateOnly?)value.Value._valueOrThrow;

    /// <summary>
    /// Implicit conversion from <see cref = "CustomDateOnly"/> to <see cref = "DateTime"/>
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator DateTime(CustomDateOnly value) => ((DateOnly)value._valueOrThrow).ToDateTime();

    /// <summary>
    /// Implicit conversion from <see cref = "DateTime"/> to <see cref = "CustomDateOnly"/>
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator CustomDateOnly(DateTime value) => DateOnly.FromDateTime(value);

    /// <inheritdoc/>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool operator <(CustomDateOnly left, CustomDateOnly right) => left._valueOrThrow < right._valueOrThrow;
