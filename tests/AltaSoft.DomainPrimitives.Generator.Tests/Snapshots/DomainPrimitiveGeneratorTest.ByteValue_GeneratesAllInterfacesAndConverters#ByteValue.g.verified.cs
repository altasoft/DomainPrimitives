...
#endif
{
    ...
    private byte _valueOrThrow => _isInitialized ? _value : throw InvalidDomainValueException.NotInitializedException(typeof(ByteValue));
    ...
    public void ValidateOrThrow(byte value)
    {
        ...
        if (!result.IsValid)
        	throw new InvalidDomainValueException(result.ErrorMessage, typeof(ByteValue), value);
    }
