...
#endif
{
    ...
    private float _valueOrThrow => _isInitialized ? _value : throw InvalidDomainValueException.NotInitializedException(typeof(FloatValue));
    ...
    public void ValidateOrThrow(float value)
    {
        ...
        if (!result.IsValid)
        	throw new InvalidDomainValueException(result.ErrorMessage, typeof(FloatValue), value);
    }
