//HintName: StringClassValue.g.cs
//------------------------------------------------------------------------------
// <auto-generated>
...
[JsonConverter(typeof(StringClassValueJsonConverter))]
[TypeConverter(typeof(StringClassValueTypeConverter))]
[UnderlyingPrimitiveType(typeof(string))]
[DebuggerDisplay("{_value}")]
public partial class StringClassValue : IEquatable<StringClassValue>
        , IComparable
        , IComparable<StringClassValue>
        , IParsable<StringClassValue>
        , IConvertible
{
    /// <inheritdoc/>
    ...
    private string _valueOrThrow => _isInitialized ? _value : throw InvalidDomainValueException.NotInitializedException(typeof(StringClassValue));
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="StringClassValue"/> class by validating the specified <see cref="string"/> value using <see cref="Validate"/> static method.
    /// </summary>
    /// <param name="value">The value to be validated.</param>
    public StringClassValue(string value) : this(value, true)
    {
    }

    private StringClassValue(string value, bool validate) 
    {
        if (validate)
        {
...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
    ...
    /// </summary>
    /// <param name="value">The value to create StringClassValue from</param>
    /// <param name="result">When this method returns, contains the created StringClassValue if the conversion succeeded, or null if the conversion failed.</param>
    /// <returns>true if the conversion succeeded; otherwise, false.</returns>
    public static bool TryCreate(string value, [NotNullWhen(true)] out StringClassValue? result)
    {
    ...
    /// <returns>true if the conversion succeeded; otherwise, false.</returns>
    public static bool TryCreate(string value, [NotNullWhen(true)]  out StringClassValue? result, [NotNullWhen(false)]  out string? errorMessage)
    {
    ...
    public void ValidateOrThrow(string value)
    {
        ...
        if (!result.IsValid)
        	throw new InvalidDomainValueException(result.ErrorMessage, typeof(StringClassValue), value);
    }
    ...
    /// <inheritdoc/>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public override bool Equals(object? obj) => obj is StringClassValue other && Equals(other);
    /// <inheritdoc/>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public bool Equals(StringClassValue? other)
    {
    ...
    /// <inheritdoc/>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool operator ==(StringClassValue? left, StringClassValue? right)
    {
    ...
    /// <inheritdoc/>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool operator !=(StringClassValue? left, StringClassValue? right) => !(left == right);
    ...
    public int CompareTo(object? obj)
    {
        ...
        if (obj is StringClassValue c)
            return CompareTo(c);

        throw new ArgumentException("Object is not a StringClassValue", nameof(obj));
    }

    /// <inheritdoc/>
    public int CompareTo(StringClassValue? other)
    {
    ...
    /// <summary>
    /// Explicit conversion from <see cref = "StringClassValue"/> to <see cref = "string"/>
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static explicit operator string(StringClassValue value) => (string)value._valueOrThrow;

    /// <inheritdoc/>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static StringClassValue Parse(string s, IFormatProvider? provider) => new (s);

    /// <inheritdoc/>
    public static bool TryParse([NotNullWhen(true)] string? s, IFormatProvider? provider, [MaybeNullWhen(false)] out StringClassValue result)
    {
        if (s is null)
        {
            result = default;
        ...
        return StringClassValue.TryCreate(s, out result);
    }
