...
public readonly partial struct DecimalValue :
...

{
	...
	public DecimalValue() : this(Default)
	{
	}
	...
	/// <inheritdoc/>
	public static bool TryParse(string? s, IFormatProvider? provider, out DecimalValue result)
	{
