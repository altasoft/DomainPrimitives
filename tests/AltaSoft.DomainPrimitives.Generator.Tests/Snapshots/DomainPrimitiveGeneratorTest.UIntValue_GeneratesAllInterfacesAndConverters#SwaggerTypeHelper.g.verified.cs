...
public static class SwaggerTypeHelper
{
	...
	{
		options.MapType<IntValue>(() => new OpenApiSchema { Type = "integer", Format = "uint32", Title = "IntValue" });
		options.MapType<IntValue?>(() => new OpenApiSchema { Type = "integer", Format = "uint32", Nullable = true, Title = "Nullable<IntValue>" });
	}
}
