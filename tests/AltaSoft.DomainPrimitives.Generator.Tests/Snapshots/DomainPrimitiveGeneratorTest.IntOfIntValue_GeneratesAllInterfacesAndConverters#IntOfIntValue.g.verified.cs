        ...
        , IConvertible
{
    ...
    private IntValue _valueOrThrow => _isInitialized ? _value : throw InvalidDomainValueException.NotInitializedException(typeof(IntOfIntValue));
    ...
    public void ValidateOrThrow(IntValue value)
    {
        ...
        if (!result.IsValid)
        	throw new InvalidDomainValueException(result.ErrorMessage, typeof(IntOfIntValue), value);
    }
