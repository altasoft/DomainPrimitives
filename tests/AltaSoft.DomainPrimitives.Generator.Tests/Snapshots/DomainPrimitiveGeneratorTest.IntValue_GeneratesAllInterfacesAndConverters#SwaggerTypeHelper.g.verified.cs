...
public static class SwaggerTypeHelper
{
	...
	{
		options.MapType<IntValue>(() => new OpenApiSchema { Type = "integer", Format = "int32", Title = "IntValue" });
		options.MapType<IntValue?>(() => new OpenApiSchema { Type = "integer", Format = "int32", Nullable = true, Title = "Nullable<IntValue>" });
	}
}
