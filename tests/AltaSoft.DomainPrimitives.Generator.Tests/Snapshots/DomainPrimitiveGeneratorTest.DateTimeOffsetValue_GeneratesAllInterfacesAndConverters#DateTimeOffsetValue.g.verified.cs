...
public readonly partial struct DateTimeOffsetValue :
		IEquatable<DateTimeOffsetValue>
		, IComparable
...

{
	...
	public DateTimeOffsetValue() : this(Default)
	{
	}
	...
	/// <inheritdoc/>
	public static bool TryParse(string? s, IFormatProvider? provider, out DateTimeOffsetValue result)
	{
