//HintName: WithoutJsonConverterValueTypeConverter.g.cs
//------------------------------------------------------------------------------
// <auto-generated>
...
public sealed class WithoutJsonConverterValueTypeConverter : UInt32Converter
{
    ...
    public override object? ConvertFrom(ITypeDescriptorContext? context, CultureInfo? culture, object value)
    {
        ...
        try
        {
            return new WithoutJsonConverterValue((uint)result);
        }
        catch (InvalidDomainValueException ex)
        {
            throw new FormatException("Cannot parse WithoutJsonConverterValue", ex);
        }
    }
}
