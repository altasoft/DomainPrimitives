        ...
        , IConvertible
{
    ...
    private bool _valueOrThrow => _isInitialized ? _value : throw InvalidDomainValueException.NotInitializedException(typeof(BoolValue));
    ...
    public void ValidateOrThrow(bool value)
    {
        ...
        if (!result.IsValid)
        	throw new InvalidDomainValueException(result.ErrorMessage, typeof(BoolValue), value);
    }
