...
public readonly partial struct DateOnlyValue :
		IEquatable<DateOnlyValue>
		, IComparable
...

{
	...
	public DateOnlyValue() : this(Default)
	{
	}
	...
	/// <inheritdoc/>
	public static bool TryParse(string? s, IFormatProvider? provider, out DateOnlyValue result)
	{
