//HintName: DateTimeOffsetValueTypeConverter.g.cs
//------------------------------------------------------------------------------
// <auto-generated>
...
public sealed class DateTimeOffsetValueTypeConverter : DateTimeOffsetConverter
{
	...
	public override object? ConvertFrom(ITypeDescriptorContext? context, CultureInfo? culture, object value)
	{
		...
		try
		{
			return new DateTimeOffsetValue((DateTimeOffset)result);
		}
		catch (InvalidDomainValueException ex)
		{
			throw new FormatException("Cannot parse DateTimeOffsetValue", ex);
		}
	}
}
