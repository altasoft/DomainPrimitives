//HintName: InternalStringValue.g.cs
//------------------------------------------------------------------------------
// <auto-generated>
...
[JsonConverter(typeof(InternalStringValueJsonConverter))]
[TypeConverter(typeof(InternalStringValueTypeConverter))]
[UnderlyingPrimitiveType(typeof(string))]
[DebuggerDisplay("{_value}")]
internal partial class InternalStringValue : IEquatable<InternalStringValue>
        , IComparable
        , IComparable<InternalStringValue>
        , IParsable<InternalStringValue>
        , IConvertible
{
    /// <inheritdoc/>
    ...
    private string _valueOrThrow => _isInitialized ? _value : throw InvalidDomainValueException.NotInitializedException(typeof(InternalStringValue));
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="InternalStringValue"/> class by validating the specified <see cref="string"/> value using <see cref="Validate"/> static method.
    /// </summary>
    /// <param name="value">The value to be validated.</param>
    public InternalStringValue(string value) : this(value, true)
    {
    }

    private InternalStringValue(string value, bool validate) 
    {
        if (validate)
        {
...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
    ...
    /// </summary>
    /// <param name="value">The value to create InternalStringValue from</param>
    /// <param name="result">When this method returns, contains the created InternalStringValue if the conversion succeeded, or null if the conversion failed.</param>
    /// <returns>true if the conversion succeeded; otherwise, false.</returns>
    public static bool TryCreate(string value, [NotNullWhen(true)] out InternalStringValue? result)
    {
    ...
    /// <returns>true if the conversion succeeded; otherwise, false.</returns>
    public static bool TryCreate(string value, [NotNullWhen(true)]  out InternalStringValue? result, [NotNullWhen(false)]  out string? errorMessage)
    {
    ...
    public void ValidateOrThrow(string value)
    {
        ...
        if (!result.IsValid)
        	throw new InvalidDomainValueException(result.ErrorMessage, typeof(InternalStringValue), value);
    }
    ...
    /// <inheritdoc/>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public override bool Equals(object? obj) => obj is InternalStringValue other && Equals(other);
    /// <inheritdoc/>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public bool Equals(InternalStringValue? other)
    {
    ...
    /// <inheritdoc/>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool operator ==(InternalStringValue? left, InternalStringValue? right)
    {
    ...
    /// <inheritdoc/>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool operator !=(InternalStringValue? left, InternalStringValue? right) => !(left == right);
    ...
    public int CompareTo(object? obj)
    {
        ...
        if (obj is InternalStringValue c)
            return CompareTo(c);

        throw new ArgumentException("Object is not a InternalStringValue", nameof(obj));
    }

    /// <inheritdoc/>
    public int CompareTo(InternalStringValue? other)
    {
    ...
    /// <summary>
    /// Implicit conversion from <see cref = "string"/> (nullable) to <see cref = "InternalStringValue"/> (nullable)
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [return: NotNullIfNotNull(nameof(value))]
    public static implicit operator InternalStringValue?(string? value) => value is null ? null : new(value);

    /// <summary>
    /// Implicit conversion from <see cref = "InternalStringValue"/> (nullable) to <see cref = "string"/> (nullable)
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [return: NotNullIfNotNull(nameof(value))]
    public static implicit operator string?(InternalStringValue? value) => value is null ? null : (string?)value._valueOrThrow;

    /// <inheritdoc/>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static InternalStringValue Parse(string s, IFormatProvider? provider) => s;

    /// <inheritdoc/>
    public static bool TryParse([NotNullWhen(true)] string? s, IFormatProvider? provider, [MaybeNullWhen(false)] out InternalStringValue result)
    {
        if (s is null)
        {
            result = default;
        ...
        return InternalStringValue.TryCreate(s, out result);
    }
