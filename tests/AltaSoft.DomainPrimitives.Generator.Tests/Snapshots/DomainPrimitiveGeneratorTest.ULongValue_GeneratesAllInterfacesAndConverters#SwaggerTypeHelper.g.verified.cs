...
public static class SwaggerTypeHelper
{
	...
	{
		options.MapType<LongValue>(() => new OpenApiSchema { Type = "integer", Format = "uint64", Title = "LongValue" });
		options.MapType<LongValue?>(() => new OpenApiSchema { Type = "integer", Format = "uint64", Nullable = true, Title = "Nullable<LongValue>" });
	}
}
